...
function templateRenderPokemonCard(i, currentPokemon) {
    let pokeName = currentPokemon[i]['name'];   // Name of pokeomon is assigned to the variable `pokeName` 
    ...
    return /*html*/ `   <div id="pokemon-${i}" class="pokemon-card column-space-between">
